            ...
            <div class="contactlist">
                ...
                <form method="post" action="<?= $PHP_SELF ?>" name='ct_form'>
                    ...
                    <div class="person_smalltext">
                        ...
                        <div style="float: right;"> <a href="javascript:do_action('cat_del_contacts', '<?= $lang['confirm_cat_remove_contacts'] ?>')"><?= $lang['cat_delete_from'] ?></a> </div>
                        ...
                        <div style="float: right;"> <a href="javascript:do_action('cat_del', '<?= $lang['confirm_cat_delete'] ?>')"><?= $lang['cat_delete'] ?></a> </div>
                        <div style="height: 3em;"></div>
