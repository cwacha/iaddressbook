...
<table width="100%">
    ...
    <tr>
        ...
        <td class="person_right" >
            <div class="person_text">
                <!-- Begin Photo Edit -->
                Remove <input type="checkbox" name="photo_delete" /><br><br>
                Change <input type="file" name="photo_file" value="" /><br>
                <!-- End Photo Edit -->
            </div>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td class="person_right">
            <div class="person_text">
                <input type="checkbox" name="company" <?php if(is_bool($contact->company) and $contact->company == true) echo "checked" ?> class="text" />
            </div>
        </td>
    </tr>    
    <!-- End Name / Company -->
    ...
    <tr>
        ...
        <td class="person_right">
            <div class="person_text">
                <textarea name="note" rows="5" cols="50"><?= $contact->note ?></textarea>
            </div>
        </td>
    </tr>
    <!-- End Notes -->
