...
class person {
    ...
    function validate() {
        ...
        if(!is_bool($this->company)) $this->company = (boolean)((int)$this_company);
    ...
    function add_address($address) {
        if(is_array($address) and !empty($address['label'])) {
    ...
    function add_email($email) {
        if(is_array($email) and !empty($email['label'])) {
    ...
    function add_phone($phone) {
        if(is_array($phone) and !empty($phone['label'])) {
    ...
    function add_chathandle($handle) {
        if(is_array($handle) and !empty($handle['label'])) {
	...
	function add_url($url) {
		if(is_array($url) and !empty($url['label'])) {
    ...
    function add_relatedname($rname) {
        if(is_array($rname) and !empty($rname['label'])) {
